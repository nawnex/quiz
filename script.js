const quizData = [
  ...
  {
    question: 'Q 306 Which sign means that pedestrians may be walking along the road?',
    Mark: 'Mark one answers',
    a: '91904602-9adb-46a9-823b-32e90ae94eb2.png',
    b: '4d707ed5-c521-4f49-8dcd-a5942024f67a.png',
    c: '5a226cfd-0a13-45d9-8c7e-08feb8622eac.png',
    d: 'c6b6dc7a-d910-44df-a603-6915441dabcb.png',
    correct: 'b',
  },
  {
    question: 'Q 307 Which shape is used for a ‘give way’ sign?',
    Mark: 'Mark one answers',
    a: 'ed85a20f-b6d4-444f-8a21-03ed27eb6257.png',
    b: '6f381fd0-816e-43e3-8671-907ec508852f.png',
    c: 'ce1b5e43-a773-4077-9b1b-f4ad163d96f2.png',
    d: '73d408ac-a53a-477a-b74d-f6e0276a6f44.png',
    correct: 'd',
  },
  {
    question: 'Q 308 Traffic signs giving orders are generally which shape?',
    Mark: 'Mark one answers',
    a: 'ce1b5e43-a773-4077-9b1b-f4ad163d96f2.png',
    b: '73d408ac-a53a-477a-b74d-f6e0276a6f44.png',
    c: 'cb94f1e0-f462-4668-a3ac-459b23819671.png',
    d: '7c9befe3-e7a4-4755-817c-9aafdd7e3038.png',
    correct: 'a',
  },
  {
    question: 'Q 309 Which of these signs means road narrows on left?',
    Mark: 'Mark one answers',
    a: '3d27ac29-caf8-406c-acf2-33b7240da984.png',
    b: '98cf8263-cdf7-4bb3-a721-4c00ccf80796.png',
    c: '7b66579c-cbde-4d55-8c9b-40822e9935aa.png',
    d: '9464387a-ab04-4166-afa5-82411cfd5992.png',
    correct: 'c',
  },
  {
    question: 'Q 310 Which sign means no overtaking?',
    Mark: 'Mark one answers',
    a: '9069d5d8-1322-49a6-9966-0a8008035a32.png',
    b: 'da8a32a0-b6ca-48de-ace9-f20d531360b7.png',
    c: 'c344db0f-c289-44c7-9445-588d15f0ac70.png',
    d: 'db04a4be-0884-41b2-9fea-943ab2052229.png',
    correct: 'a',
  },
  {
    question: 'Q 311 Which sign means no waiting?',
    Mark: 'Mark one answers',
    a: '21459f97-6fe6-45b2-b619-290c55e6dc2d.png',
    b: 'ce1b5e43-a773-4077-9b1b-f4ad163d96f2.png',
    c: '10679dc3-5ccc-4629-b57b-7de31b5c9cf6.png',
    d: '3776293f-6d83-4258-94b3-4b0f08a9c42d.png',
    correct: 'd',
  },
  {
    question: 'Q 312 You MUST obey signs giving orders. These signs are usually:',
    Mark: 'Mark one answers',
    a: 'Circular',
    b: 'Triangular',
    c: 'Rectangular',
  ...
  {
    question: 'Q 313 What shape is a STOP sign?',
    Mark: 'Mark one answers',
    a: 'Circular',
    b: 'Triangular',
    c: 'Inverted triangle',
  ...
  {
    question: 'Q 314 Signs with blue circles are mostly?',
    Mark: 'Mark one answers',
    a: 'Orders',
    b: 'Warnings',
    c: 'Compulsory',
  ...
  {
    question: 'Q 315 Information signs are usually?',
    Mark: 'Mark one answers',
    a: 'Circular',
    b: 'Rectangular',
    c: 'Triangular',
  ...
  {
    question: 'Q 316 Triangular signs are mostly?',
    Mark: 'Mark one answers',
    a: 'Signs giving orders',
    b: 'Signs giving warnings',
    c: 'Signs giving positive instruction',
    d: 'Signs giving directions',
    picture: '9fc00d94-a837-4870-8ac5-4756c5ede180.png',
    correct: 'b',
  },
  {
    question: 'Q 317 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Ahead only',
    b: 'Level crossing with gate',
    c: 'Level crossing without gate',
    d: 'Crossroads',
    picture: 'c70885e4-209f-4f90-a97f-c38c13d4f430.png',
    correct: 'd',
  },
  {
    question: 'Q 318 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Bend to the right',
    b: 'No traffic from the right',
    c: 'No right turn',
    d: 'Road on the right close',
    picture: '1550bbeb-d441-468b-9638-04b4e2752d43.png',
    correct: 'c',
  },
  {
    question: 'Q 319 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No right turn',
    b: 'No left turn',
    c: 'Give way to traffic on your right',
    d: 'No entry',
    picture: '7c1740ca-6693-4c3b-9877-407247de891d.png',
    correct: 'b',
  },
  {
    question: 'Q 320 Which FOUR of these would be indicated by a triangular road sign?',
    Mark: 'Mark four answers',
  ...
  {
    question: 'Q 321 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No left Lane',
    b: 'No left turn',
    c: 'No U-turns',
    d: 'Left lane ends',
    picture: '2f907b0d-4c09-4643-a386-a967fd6e101c.png',
    correct: 'c',
  },
  {
    question: 'Q 322 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No motor vehicles',
    b: 'No overtaking',
    c: 'No cars',
    d: 'Dual carriage way',
    picture: '9069d5d8-1322-49a6-9966-0a8008035a32.png',
    correct: 'b',
  },
  {
    question: 'Q 323 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No stopping',
    b: 'Parking or waiting restricted',
    c: 'No motor vehicles',
    d: 'No parking',
    picture: '3776293f-6d83-4258-94b3-4b0f08a9c42d.png',
    correct: 'b',
  },
  {
    question: 'Q 324 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No stopping (Clearway)',
    b: 'Waiting restrictions apply',
    c: 'No entry',
    d: 'No parking',
    picture: '21459f97-6fe6-45b2-b619-290c55e6dc2d.png',
    correct: 'a',
  },
  {
    question: 'Q 325 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No entry',
    b: 'No vehicles',
    c: 'Stop',
    d: 'Give way',
    picture: 'ce1b5e43-a773-4077-9b1b-f4ad163d96f2.png',
    correct: 'b',
  },
  {
    question: 'Q 326 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No through road',
    b: 'No entry for vehicular traffic',
    c: 'Road closed ahead',
    d: 'Motorway exit',
    picture: 'f375318e-1deb-4965-9d62-39e3c10a9361.png',
    correct: 'b',
  },
  {
    question: 'Q 327 What MUST you do when you see this sign?',
    Mark: 'Mark one answers',
    a: 'Stop, only if a red light is showing',
    b: 'Stop, only if children are waiting to cross',
    c: 'Stop, even if the road is clear',
    d: 'Stop, only if traffic is approaching',
    picture: 'f53485de-557e-4cb3-b79b-f077dc9822c8.png',
    correct: 'c',
  },
  {
    question: 'Q 328 What MUST you do when you see this sign?',
    Mark: 'Mark one answers',
    a: 'Stop',
    b: 'Give way to traffic on major road',
    c: 'No parking',
    d: 'No vehicles',
    picture: '73d408ac-a53a-477a-b74d-f6e0276a6f44.png',
    correct: 'b',
  },
  {
    question: 'Q 329 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Warning zigzag road ahead',
    b: 'Sharp bend ahead',
    c: 'Bend to right',
    d: 'Reduce speed before turning right',
    picture: '21084f72-ddbe-4ce2-a76a-935d0802b22a.png',
    correct: 'c',
  },
  {
    question: 'Q 330 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Slippery road when wet',
    b: 'Double bend first to left',
    c: 'Double bend first to right',
    d: 'Zigzag road ends ahead',
    picture: 'f0d88251-6526-4731-a9dc-e6a2486a0a01.png',
    correct: 'b',
  },
  {
    question: 'Q 331 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Double bend first to right',
    b: 'Bend to left',
    c: 'Junction on bend',
    d: 'Slippery road',
    picture: 'baeec494-cf53-4b53-86aa-c29903cfe2db.png',
    correct: 'a',
  },
  {
    question: 'Q 332 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Zigzag road ahead',
    b: 'Uneven road surface',
    c: 'Slippery road',
    d: 'Ice conditions ahead',
    picture: '83172189-efdd-4421-9267-cc04c2f77b0c.png',
    correct: 'c',
  },
  {
    question: 'Q 333 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Falling or fallen rocks',
    b: 'Side winds',
    c: 'Quayside or riverbank',
    d: 'Uneven surface',
    picture: '97be531f-1a33-45c0-b45e-625288a8c137.png',
    correct: 'a',
  },
  {
    question: 'Q 334 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Bridge ahead',
    b: 'Ford ahead',
    c: 'Tunnel ahead',
    d: 'Uneven road',
    picture: '0f5a536a-d616-4e99-b942-cb4235c1b612.png',
    correct: 'd',
  },
  {
    question: 'Q 335 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Traffic signals end',
    b: 'Pedestrian crossing',
    c: 'No through road',
    d: 'Traffic light',
    picture: 'b21444ad-746a-4e22-900a-f68d22ec19b2.png',
    correct: 'd',
  },
  {
    question: 'Q 336 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Road narrows on right',
    b: 'Single lane traffic ahead',
    c: 'Dual carriageway ends',
    d: 'Road narrows on both sides',
    picture: '3d27ac29-caf8-406c-acf2-33b7240da984.png',
    correct: 'd',
  },
  {
    question: 'Q 337 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Move into right lane',
    b: 'Road narrows on left',
    c: 'Right Lane ends ahead',
    d: 'Warning two lane motorway',
    picture: '7b66579c-cbde-4d55-8c9b-40822e9935aa.png',
    correct: 'b',
  },
  {
    question: 'Q 338 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Move into left lane',
    b: 'End of left lane',
    c: 'Two way traffic',
    d: 'Road narrows on right',
    picture: '98cf8263-cdf7-4bb3-a721-4c00ccf80796.png',
    correct: 'd',
  },
  {
    question: 'Q 339 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'T-junction',
    b: 'No through road',
    c: 'Turn right',
    d: 'Side road',
    picture: 'd550e20a-72f1-47a7-94f8-cc22ae8e65ae.png',
    correct: 'd',
  },
  {
    question: 'Q 340 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Crossroads',
    b: 'Staggered junction',
    c: 'Junction on bend',
    d: 'T-junction',
    picture: 'efc53fc7-d3bc-454f-ad3f-3fa1e2dd7912.png',
    correct: 'b',
  },
  {
    question: 'Q 341 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Low bridge ahead',
    b: 'Railway tunnel ahead',
    c: 'Hump bridge',
    d: 'Tunnel ahead',
    picture: '2cbaded0-f1fd-45b6-b708-8c09801def9f.png',
    correct: 'c',
  },
  {
    question: 'Q 342 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Steep hill downwards',
    b: 'Loose chippings',
    c: 'Accident spot',
    d: 'Uphill gradient',
    picture: '394a2b58-5b01-4c5b-ae2a-51e83d605470.png',
    correct: 'a',
  },
  {
    question: 'Q 343 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Loose chippings',
    b: 'Accident spot',
    c: 'Steep hill upwards',
    d: 'Downhill gradient',
    picture: '6c5afbc0-065b-448c-a3df-d8270f02b2a1.png',
    correct: 'c',
  },
  {
    question: 'Q 344 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'School Patrol',
    b: 'Pedestrian crossing',
    c: 'Traffic island',
    d: 'Elderly people crossing',
    picture: '5a226cfd-0a13-45d9-8c7e-08feb8622eac.png',
    correct: 'b',
  },
  {
    question: 'Q 345 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No vehicles',
    b: 'Mini-roundabout',
    c: 'Roundabout',
    d: 'Ring road',
    picture: '97e678dd-4ba3-41ea-b7dd-63262b64c098.png',
    correct: 'c',
  },
  {
    question: 'Q 346 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Aircraft only',
    b: 'Oncoming airport',
    c: 'Low flying aircraft or sudden aircraft noise',
    d: 'Trams crossing ahead',
    picture: '86159861-0006-4827-8482-2d79a54c05d9.png',
    correct: 'c',
  },
  {
    question: 'Q 347 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Dual carriageway ends',
    b: 'T-junction',
    c: 'Two-way traffic straight ahead',
    d: 'Danger ahead',
    picture: 'fc16e448-329a-4475-bef5-814f13e73d6a.png',
    correct: 'b',
  },
  {
    question: 'Q 348 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'You have right of way',
    b: 'No overtaking',
    c: 'Two-way traffic straight ahead',
    d: 'Oncoming traffic has priority',
    picture: 'da8a32a0-b6ca-48de-ace9-f20d531360b7.png',
    correct: 'c',
  },
  {
    question: 'Q 349 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Two-way traffic straight ahead',
    b: 'Two-way traffic over a bridge',
    c: 'Two-way traffic crosses a two-way road',
    d: 'Two-way traffic crosses one-way road',
    picture: 'cf37ff47-e7d8-474d-a871-33670a023bf5.png',
    correct: 'd',
  },
  {
    question: 'Q 350 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Goods vehicles access',
    b: 'No goods vehicles over unladen weight shown (unladen weight limit)',
    c: 'Goods vehicles with unladen weight shown (unladen weight limit)',
    d: 'No access to goods vehicles',
    picture: 'e25549d8-b4a6-48a2-9db4-28e55bd6a42a.png',
    correct: 'b',
  },
  {
    question: 'Q 351 Which type of vehicle does this sign apply to?',
    Mark: 'Mark one answers',
    a: 'No vehicles over width shown',
    b: 'High Vehicles',
    c: 'Long Vehicles',
    d: 'Heavy Vehicles',
    picture: '1b320b6a-2d9b-471d-ab94-ed823948e4d6.png',
    correct: 'a',
  },
  {
    question: 'Q 352 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No vehicles over the width shown',
    b: 'No vehicle or combination of vehicles over length shown',
    c: 'No vehicles',
    d: 'No vehicles over the height shown',
    picture: 'a62b3577-9679-4948-893d-3551e19ef57f.png',
    correct: 'b',
  },
  {
    question: 'Q 353 What does this sign mean? ',
    Mark: 'Mark one answers',
    a: 'No cars',
    b: 'No motorbikes',
    c: 'No entry',
    d: 'No motor vehicles',
    picture: '10679dc3-5ccc-4629-b57b-7de31b5c9cf6.png',
    correct: 'd',
  },
  {
    question: 'Q 354 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No motor vehicles',
    b: 'No motor vehicles except solo motor cycles, scooters or mopeds',
    c: 'Single lane',
    d: 'No overtaking',
    picture: '63f102b6-5701-4dcd-aa01-3a0ae5dd12f1.png',
    correct: 'b',
  },
  {
    question: 'Q 355 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Pedestrian crossing ahead',
    b: 'Pedestrians in the road ahead',
    c: 'No pedestrians',
    d: 'Pedestrian zone - no vehicles allowed',
    picture: '043fce85-be34-4d11-94a6-ddbdd583d0c4.png',
    correct: 'c',
  },
  {
    question: 'Q 356 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Unladen weight limit',
    b: 'Maximum speed',
    c: 'Minimum speed',
    d: 'National speed limit',
    picture: '0177b50c-8ef4-4e04-a8c0-0cce9bdbb2f6.png',
    correct: 'b',
  },
  {
    question: 'Q 357 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'School crossing ahead',
    b: 'No pedestrians allowed',
    c: 'Pedestrian zone - no vehicles allowed',
    d: 'Footpath ahead',
    picture: '91904602-9adb-46a9-823b-32e90ae94eb2.png',
    correct: 'a',
  },
  {
    question: 'Q 358 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Diversion ahead',
    b: 'One way traffic',
    c: 'Ahead only',
  ...
  {
    question: 'Q 359 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Give way to traffic on your left',
    b: 'No left turn',
    c: 'Right turn ahead',
    d: 'Left turn ahead',
    picture: 'ccdd1a59-a33c-4977-a1ca-a5acf9b040e3.png',
    correct: 'd',
  },
  {
    question: 'Q 360 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Give way to traffic on your right',
    b: 'Right turn ahead',
    c: 'Left turn ahead',
    d: 'No right turn',
    picture: '32be8157-06aa-41e5-8ade-ec122c28cbb6.png',
    correct: 'b',
  },
  {
    question: 'Q 361 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Diversion to the right',
    b: 'Turn right',
    c: 'Keep right',
    d: 'Single lane',
    picture: 'ae34f80e-bc09-438b-bc73-f476153df4d8.png',
    correct: 'b',
  },
  {
    question: 'Q 362 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Turn left',
    b: 'Keep left',
    c: 'Single lane',
    d: 'Diversion to the left',
    picture: '00f45b36-c308-43f6-8982-5fd4b26a011c.png',
    correct: 'a',
  },
  {
    question: 'Q 363 What does this sign mean? ',
    Mark: 'Mark one answers',
    a: 'Turn left',
    b: 'Keep left',
    c: 'Single lane',
    d: 'Traffic passes on the left',
    picture: 'a2ac7f60-6512-41c7-b587-58d0c239ce2b.png',
    correct: 'b',
  },
  {
    question: 'Q 364 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Traffic passes on the left',
    b: 'Turn right',
    c: 'Keep right',
    d: 'Single lane',
    picture: 'blob1.jpeg',
  ...
  {
    question: 'Q 365 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Give way to vehicles on left and right',
    b: 'Traffic passes on both sides',
    c: 'Vehicles may pass either side to reach same destination',
    d: 'Turn off at next the junction on the motorway',
    picture: 'd5fe17e9-da56-435e-af6a-db6f11af1531.png',
    correct: 'c',
  },
  {
    question: 'Q 366 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'Ahead only',
    b: 'One way traffic',
    c: 'No waiting',
    d: 'Diversion ahead',
    picture: '21c56841-cb4f-4f54-b25f-1d0939212b6f.png',
    correct: 'b',
  },
  {
    question: 'Q 367 What does this sign mean?',
    Mark: 'Mark one answers',
    a: 'No Cycles',
    b: 'Route to be used by pedal cyclist only',
    c: 'Cycle route ahead',
    d: 'Secure cycle parking ahead',
    picture: 'ce832883-6645-46c6-bb97-dd315acf1e86.png',
    correct: 'b',
  },
  {
    question: 'Q 368 You are driving along the motorway in the inside lane. You intend to turn right at the next available exit. When should you signal right?',
    Mark: 'Mark one answers',
    a: 'At the third count-down marker (100 meters to go)',
    b: 'At the second count-down marker (200 meters to go)',
    c: 'At the first count-down marker (300 meters to go)',
    d: 'When you have reached the slip road',
    picture: 'b54b4990-40b5-4cd5-84b6-d69cf9b645ad.png',
    correct: 'b',
  },
  {
...
if(vehicle === 'car'){
  while(arr.length < 20){
      var r = Math.floor(Math.random() * 268) + 100;
      if(arr.indexOf(r) === -1) arr.push(r);
  quizlen = 20
}}
if(vehicle === 'bike'){
  while(arr.length < 20){
    var r = Math.floor(Math.random() * 214);
    if(arr.indexOf(r) === -1) arr.push(r);
  quizlen = 20
}}
...
const image_change = document.getElementById("image_change")
...
const getSelected = () => {
    if(quizData[arr[loop]].correct.length > 1) answer = []
    if(quizData[arr[loop]].correct.length === 1) answer = 'undefined'
    ...
    if(quizData[arr[loop]].correct.length !== answer.length) {everything = false
...
const endearly = () => {
  quiz.innerHTML = `
  <h2>You answered ${score}/${loop/*loop*/} questions correctly</h2>
  <h2>Thats ${((score/loop)*100)}${'%'} </h2>
  ...
  broke = 0
    ...
    if(image > 1){
      ...
      if(myImg1check.length > 0) {
        ...
        document.querySelector('.myImg4').style.removeProperty("background");
      }
      a_text.classList.remove('myImg1');
    ...
    if(Object.keys(quizData[arr[loop]]).length === 8) {
      if(!('picture' in quizData[arr[loop]])){
      ...
      f_text.style.display = "none";
      f.style.display = "none";} 
    if(Object.keys(quizData[arr[loop]]).length === 9 || Object.keys(quizData[arr[loop]]).length === 10) {
      e_text.style.display = "inline";
      e.style.display = "inline";
    ...
    if('picture' in quizData[arr[loop]]){
      ...
      img.src = `Traffic_signs/${currentQuizData.picture}`;
      img.setAttribute('id', 'right_image')
      image_change.insertBefore(img, image_change.firstChild);}
  }
    if(image === 1) {
      image_change.classList.add('image-grid')
      document.querySelector(".hide").style.display = 'none';
      document.querySelector(".hide2").style.display = 'none';
      a_text.classList.add('myImg1');
      b_text.classList.add('myImg2');
      c_text.classList.add('myImg3');
      d_text.classList.add('myImg4');
      questionElement.innerText = currentQuizData.question;
      document.querySelector(".myImg1").style.background = `url('Traffic_signs/${currentQuizData.a}') 0 0 no-repeat`
      document.querySelector(".myImg2").style.background = `url('Traffic_signs/${currentQuizData.b}') 0 0 no-repeat`
      document.querySelector(".myImg3").style.background = `url('Traffic_signs/${currentQuizData.c}') 0 0 no-repeat`
      document.querySelector(".myImg4").style.background = `url('Traffic_signs/${currentQuizData.d}') 0 0 no-repeat`
    }
...
submitButton.addEventListener("click", () => {
  ...
  if(everything === false)document.getElementById("check2").innerHTML = 'not marked enough'
  if(everything){
    broke++;
    a.disabled = true;
    b.disabled = true;
    ...
    f.disabled = true;
      ...
      for (let i = 0; i < quizData[arr[loop]].correct.length; i++) {
        if(quizData[arr[loop]].correct[i] === 'a') a_text.style.color = 'green'
        if(quizData[arr[loop]].correct[i] === 'b') b_text.style.color = 'green'
        if(quizData[arr[loop]].correct[i] === 'c') c_text.style.color = 'green'
        if(quizData[arr[loop]].correct[i] === 'd') d_text.style.color = 'green'
        if(quizData[arr[loop]].correct[i] === 'e') e_text.style.color = 'green'
        if(quizData[arr[loop]].correct[i] === 'f') f_text.style.color = 'green'
      }
    ...
    if(broke === 1){
      total = 0;
        ...
        if(yes === true) document.getElementById("check2").innerHTML = 'Yep! Answer was: '.concat(quizData[arr[loop]].correct)
        if(yes === false) document.getElementById("check2").innerHTML = 'Nope! Answer was: '.concat(quizData[arr[loop]].correct)
      }
      if(broke !== 2)return
      if(image === 3) {
      ...
      e.disabled = false;
      f.disabled = false;
      a_text.style.color = 'black'
      b_text.style.color = 'black'
      c_text.style.color = 'black'
      d_text.style.color = 'black'
      e_text.style.color = 'black'
      f_text.style.color = 'black'
